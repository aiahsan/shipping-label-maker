            ...
            <div className="row ">
                <div className="col-12 ">
                    <div className="container mt-5 w-80per">
                        ...
                        <p className="mt-n2">Enter the Receiver's Address</p>

                        <div className="mt-5">
                            <Formik
                                initialValues={{
                                    name: values&&values.to&&values.to.name?values.to.name:"",
                                    street:  values&&values.to&&values.to.street?values.to.street:"",
                                    state:  values&&values.to&&values.to.state?values.to.state:"",
                                    zip:  values&&values.to&&values.to.zip?values.to.zip:"",
                                    city: values&&values.to&&values.to.city?values.to.city:""
                      
                                }}
                                onSubmit={async (values, { setSubmitting }) => {
                                    handleNext({to:{...values}})
                            ...
                            <button onClick={()=>handlePrevious()} className="btn bg-main mt-4 ml-2" >
                            Previous
